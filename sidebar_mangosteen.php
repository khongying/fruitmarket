...
<ul class="nav nav-tabs">
    ...
    <li class="nav-item" id="3_step">
        <a id="step_3" class="nav-link" href="#">การให้น้ำ</a>
    </li>
...
$( document ).ready(function() {
	function show_step_1(){
		$.get('mangosteen/mangosteen_step_1.php', function(data) {
		}).done(function(data){
			$("#detail").html(data);
		});
	}
	function show_step_2(){
		$.get('mangosteen/mangosteen_step_2.php', function(data) {
		}).done(function(data){
			$("#detail").html(data);
		});
	}
	function show_step_3(){
		$.get('mangosteen/mangosteen_step_3.php', function(data) {
		}).done(function(data){
			$("#detail").html(data);
		});
	}
	function show_step_4(){
		$.get('mangosteen/mangosteen_step_4.php', function(data) {
		}).done(function(data){
			$("#detail").html(data);
		});
	}
