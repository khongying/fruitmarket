    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h2><img src="logo/fields.png" />  แก้ไขสวนผลไม้ (เช่า)</h2><hr/>
                            ...
                            <?php
                                $sql = "SELECT * FROM `hire_garden` WHERE `id` = '{$id}'";
                                $result=getpdo($con,$sql,1);
                                foreach ($result as $row) {
                            ?>
                                <form action="garden_edit.php" name="product" method="POST" class="form-horizontal" onSubmit="return chkfrom();">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 info">
                                            <p>ID:LINE</p>
                                            <input type="text" name="line" class="form-control" value="<?= $row['line'] ?>"/>
                                        </div>
                                    </div>
